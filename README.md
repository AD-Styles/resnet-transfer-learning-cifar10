...
> 📌 **핵심 분석 인사이트**
> * 파라미터가 약 **79.1% 증가**(24.11M → 43.19M)했음에도, 정확도 향상은 단 **0.27%p**에 그쳤습니다.
> * 추론 시간(Latency)은 14.57ms에서 27.80ms로 **거의 2배(1.9배) 가까이 느려졌습니다.**
> * 단위 파라미터당 정확도 효율(Acc/M params)을 비교하면, **ResNet50이 약 1.8배 더 효율적**입니다.
---
